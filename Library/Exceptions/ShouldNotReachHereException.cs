namespace AssertLibrary
{
    ...
    public class ShouldNotReachHereException : Exception
    {
        ...
        /// </exception>
        protected ShouldNotReachHereException(SerializationInfo info, StreamingContext context) : base(info, context) { }
        ...
        /// </param>
        public ShouldNotReachHereException(string message, Exception innerException) : base(message, innerException) { }
    }
}
